...
class CourseClass:
    def __init__(self,root): 
        ...
        #====title=====
        title=Label(self.root,text="Manage Course Details",padx=10,compound=LEFT,font=("callibri",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=35)
        ...
        #=====widgets=====
        lbl_coursename=Label(self.root,text="Course Name:",font=("callibri",15,'bold'),bg='white').place(x=10,y=60)
        lbl_duratuion=Label(self.root,text="Duration:",font=("callibri",15,'bold'),bg='white').place(x=10,y=100)
        lbl_charges=Label(self.root,text="Charges:",font=("callibri",15,'bold'),bg='white').place(x=10,y=140)
        lbl_description=Label(self.root,text="Description:",font=("callibri",15,'bold'),bg='white').place(x=10,y=180)
        
        self.txt_coursename=Entry(self.root,textvariable=self.var_course,font=("callibri",15,'bold'),bg='lightyellow')
        self.txt_coursename.place(x=150,y=60,width=200)
        self.txt_duration=Entry(self.root,textvariable=self.var_duration,font=("callibri",15,'bold'),bg='lightyellow')
        self.txt_duration.place(x=150,y=100,width=200)
        self.txt_charges=Entry(self.root,textvariable=self.var_charges,font=("callibri",15,'bold'),bg='lightyellow')
        ...
        lbl_search=Label(self.root,text="Course Name:",font=("callibri",15,'bold'),bg='white').place(x=720,y=60)
        txt_search=Entry(self.root,textvariable=self.var_search,font=("callibri",15,'bold'),bg='lightyellow')
        txt_search.place(x=870,y=60,width=180)
